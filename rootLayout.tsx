...
const navigation = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/logan-anderson/demos.cool",
    icon: (props: Record<string, string>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
...
const Layout = ({ demos, url }: { demos: string[]; url: string }) => {
  return (
    <html lang="en" className="bg-brand-600">
      <head>
        <meta charSet="UTF-8" />
      ...
      <body className="bg-gradient-to-r from-brand-700 via-brand-600 to-brand-500 text-gray-100 min-h-screen flex flex-col justify-between">
